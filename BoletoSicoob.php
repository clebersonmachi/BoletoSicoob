...
class BoletoSicoob{
	...
	*/
	public function gerarArquivo(){
		...
		$pasta = path('storage').'/boletos';
		File::mkdir($pasta);

		$arquivoNome = 'remessa-cnab400-'.date('d-m-Y').'.txt';
		$arquivo = "{$pasta}/$arquivoNome";

		// busca os dados para remessa
		$boletos = static::mkFinanceiroModel()->get();
